...
public interface MyDslPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute list '{@link org.xtext.example.mydsl.myDsl.Model#getS <em>S</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>S</em>'.
   * @see org.xtext.example.mydsl.myDsl.Model#getS()
   * @see #getModel()
   * @generated
   */
  EAttribute getModel_S();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute MODEL__S = eINSTANCE.getModel_S();
